...
public final class EagerlyRotatingNanoIpRoutePlanner extends AbstractRoutePlanner {

  private static final Logger log = LoggerFactory.getLogger(EagerlyRotatingNanoIpRoutePlanner.class);
  ...
  public EagerlyRotatingNanoIpRoutePlanner(final List<IpBlock> ipBlocks) {
    this(ipBlocks, ip -> true);
  }

  public EagerlyRotatingNanoIpRoutePlanner(final List<IpBlock> ipBlocks, final Predicate<InetAddress> ipFilter) {
    this(ipBlocks, ipFilter, true);
  }

  public EagerlyRotatingNanoIpRoutePlanner(final List<IpBlock> ipBlocks, final Predicate<InetAddress> ipFilter, final boolean handleSearchFailure) {
